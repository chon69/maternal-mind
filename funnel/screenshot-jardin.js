...
const OUT  = path.join(__dirname, 'jardin-img');
fs.mkdirSync(OUT, { recursive: true });

const carruseles = [
  { file: 'carrusel-jardin-1.html', prefix: 'jardin1', slides: 5 },
  { file: 'carrusel-jardin-2.html', prefix: 'jardin2', slides: 5 },
  { file: 'carrusel-jardin-3.html', prefix: 'jardin3', slides: 5 },
  { file: 'carrusel-jardin-4.html', prefix: 'jardin4', slides: 5 },
];
...
async function main() {
  ...
  console.log('TOTAL', n, 'PNG en funnel/jardin-img/');
}
