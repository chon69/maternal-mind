...
function activationEmail(nombre, activationUrl) {
  const content = `
    ...
    <p style="margin:0 0 28px;text-align:center;"><a href="${activationUrl}" style="color:#4AADA7;font-family:Arial,sans-serif;font-size:15px;">Acceder a mi espacio en Maternal Mind →</a></p>
