...
function activationEmail(nombre, activationUrl) {
  const content = `
    ...
    <p style="margin:0 0 16px;color:#5E5E5E;line-height:1.75;">Te dejo tu <strong style="color:#3A3A3A;">Kit de Pausa</strong>: cinco prácticas pequeñas y reales para volver a ti en cualquier momento del día. No tienes que registrarte ni recordar ninguna contraseña — el enlace es tuyo y no caduca.</p>
    <div style="text-align:center;margin:32px 0;">
      <a href="${APP_URL}/kit" style="display:inline-block;background:#7DCFCA;color:#fff;font-family:Arial,sans-serif;font-size:16px;font-weight:600;text-decoration:none;padding:17px 48px;border-radius:8px;">Escuchar mi Kit de Pausa →</a>
    </div>
    <p style="margin:0 0 16px;color:#5E5E5E;line-height:1.75;">Y si además quieres tu espacio en Maternal Mind —los círculos y eventos, el blog, el podcast—, puedes crearlo cuando te apetezca eligiendo una contraseña:</p>
