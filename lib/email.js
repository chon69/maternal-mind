...
function activationEmail(nombre, activationUrl) {
  const content = `
    ...
    <p style="margin:0 0 16px;color:#5E5E5E;line-height:1.75;">Te dejo tu <strong style="color:#3A3A3A;">Kit de Pausa</strong>: cinco prácticas pequeñas y reales para volver a ti en cualquier momento del día.</p>
