...
(function () {
  const ICONS = {
    ...
    community: `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="7" r="4"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/><path d="M21 21v-2a4 4 0 0 0-3-3.87"/></svg>`,
  ...
  const NAV = [
    ...
    { href: '/app/admin/testimonios.html',icon: 'quote',    label: 'Testimonios',  match: ['/app/admin/testimonios.html'] },
    { section: 'Comunidad' },
    { href: '/app/admin/comunidad.html', icon: 'community', label: 'Publicaciones', match: ['/app/admin/comunidad.html'] },
    { href: '/app/admin/mensajes.html',  icon: 'inbox',     label: 'Mensajes',      match: ['/app/admin/mensajes.html'] },
